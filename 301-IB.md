...
<table width="50%" border="0">
  ...
  <tr>
    ...
    <br/><br/>
      eg. "<strong>77a541a4-cf5f-4069-8c92-4a8b718fd5cd</strong>"
    <br/><br/>
    Note: the current version will be supplied by the moderator</td>
  </tr>
  <tr>
    <td>MetaData URL:</td>
    <td>
    ...
    <br/><br/>
    eg. https://mobile-apacdemo12.mobileenv.us2.oraclecloud.com:443/mobile/custom/CafeSupremoTD2/components
    <br/><br/>
    Note: the current host base URL will be supplied by the moderator</td>
  </tr>
  <tr><td colspan=2></td></tr>
  <tr>
  ...
  <tr>
    ...
    <br/><br/>
    eg. "<strong>QVBBQ0RFTU8xMl9NT0JJTEVfTU9CSUxFX0FOT05ZTU9VU19BUFBJRDpEbGd2NF9pemttd2Exbw==</strong>"
    <br/><br/>  
    Note: the current version will be supplied by the moderator
    </td>
  </tr>
</table>
