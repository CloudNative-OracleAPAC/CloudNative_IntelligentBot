...
<img src="img/lab5-2a.png" width="40%"/>
...
<img src="img/lab5-12.png" width="75%"/>
...
<img src="img/lab5-19.png" width="100%"/>
...
<img src="img/lab5-20a.png" width="15%"/>

21. Choose “ when value changes to true” from condition Pop-list.

<img src="img/lab5-21.png" width="75%"/>

22. Click  the `+ Add Action` link to associate a specific action (S) to the specified event.

<img src="img/lab5-22.png" width="75%"/>

 - Select the “**Make Elements Visible**” Tile to specify which elements will be effected by this event

<img src="img/lab5-22b.png" width="15%"/>

23. Drag the “**Choose_Dressing_Type**” Radio Button element from the list of available elements and drop it on the “Action: Make Elements Visable” drop target for the action.

<img src="img/lab5-23.png" width="75%"/>
...
<img src="img/lab5-23b.png" width="75%"/>
...
<img src="img/lab5-25d.png" width="15%"/>
...
27.	We need to define which information is to be passed back to the Bot’s Conversation flow.  This is done by adding the required information as Parameters to the “Exit To Bot” Action created in step 25
 ...
 - Click the `+ Add Parameter` to six (6) outbound parameters to the Action
 
  <img src="img/lab5-27a.png" width="40%"/>
...
30.	Select the Dialog Tab in the left hand toolbar (3rd Icon) to open the Dialogue flow in the BotML Text Editor.
  ...
  <img src="img/lab5-30.png" width="10%"/>
  
31.	Scroll down to find the Coversation Step (otherwise know as States) that activates the Instant App Sandwich Wizard

 NOTE: In this case the Step is named “**designYourLunch**” and is defined as a **_System.Interactive_** component.

```
# #########################################################################################
# TEST DRIVE LAB 5 : Instant Apps for Structured ContentCustom Component 
#
...
Note: 
 ...
 32. Replace the “success” action transition in the showMenu conversation State (as used in Lab 4).  Replace “**getFoodHeatedOption**” with a reference to “**wasSandwichChosen**".
...
<img src="img/lab5-33a.png" width="40%"/>

 - Enter the utterance “I want some lunch”
 
<img src="img/lab5-33b.png" width="40%"/>
 ...
 <img src="img/lab5-33c.png" width="40%"/>
 ...
 - Having received the confirmation screen, click the [X] on the Browser Tab to Close the page.  Click back onto the Tab containing the Bot Tester.
   ...
   <img src="img/lab5-33g.png" width="40%"/>
