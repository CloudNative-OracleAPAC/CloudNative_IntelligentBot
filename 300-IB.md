...
[OPTION 2](302-IB.md):  Intended for “Professional Developers” who will be looking at creating the custom components and need to understand the basic structure of the Component deployed to the Oracle Mobile Cloud.  This option adds additional steps over [OPTION 1](301-IB.md) by adding the following:
