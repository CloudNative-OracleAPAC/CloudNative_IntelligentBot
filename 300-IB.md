...
[OPTION 2](302-IB.md):  Intended for “Professional Developers” who will be looking at creating the custom components and need to understand the basic structure of the Component deployed to the Oracle Mobile Cloud.  This option adds additional steps to Option 1 by adding the following;
...
<table width="50%" border="0">
  <tr>
    <td align="Center">[OPTION 1](301-IB.md)</td>
    <td width="20%"></td>
    <td align="Center">[OPTION 2](301-IB.md)</td>
  </tr>
</table>
