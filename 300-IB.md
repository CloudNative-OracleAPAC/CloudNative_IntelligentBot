...
In this Lab Session, you will be:
 ...
 - Seeing how the use of Custom Components allows for 
   ...
   - The use of additional, UI capabilities to improve the user experience (including support for channel specific features such as additional UX functions within Facebook Messenger). 
