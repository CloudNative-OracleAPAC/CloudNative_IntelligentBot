...
<table width="75%" border="1">
  <tr>
    <td align="Center"><img src="img/lab3-intro-1.png" width="40%"/></td>
    <td>Converted to</td>
    <td align="Center"><img src="img/lab3-intro-2.png" width="40%"/></td>
  </tr>
</table>
...
```
# #########################################################################################
# TEST DRIVE LAB 4: Custom Component
#
...
# (Replace success Action in Lab 5 = "wasSandwichChosen")
# #########################################################################################
